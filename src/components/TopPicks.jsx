...
import pant from '../assets/img/pant.png'

import brown from '../assets/img/brown cot.png'

import shoes from '../assets/img/brown shoes.png'
                ...
                <div className='mt-[40px] flex gap-[42px]'>
                    ...
                    <div>
                        ...
                        <div className='bg-neutral-100  pt-4 pl-4 pr-4'>
                            <small className='text- primary  font-bold bg-[#E9E2D8] p-2 instrument-sans'>30% Off</small>
